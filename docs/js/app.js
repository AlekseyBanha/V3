            ...
            function searchListActions() {
                ...
                if (filters.length) filters.forEach((filter => {
                    if (filter) {
                        ...
                        const currentBlockContent = currentBlock.querySelector(".block-account__content");
                        ...
                        filter.onkeyup = () => {
                            ...
                            listShow(filter, currentBlockContent);
                        };
                        function listShow(input, listBlock) {
                            if (input.value.length >= 1) listBlock.style.overflow = "auto"; else listBlock.style.overflow = "hidden";
                        }
                    }
                }));
            }
            function chooseListItem() {
                ...
                if (itemBlocks.length) itemBlocks.forEach((itemBlock => {
                    ...
                    itemBlock.addEventListener("click", (function(e) {
                        ...
                        if (target.closest(".item-account-select") && !target.closest("button").classList.contains("item-selected") && !target.closest(".item-account-select__favourite")) if (target.closest(".item-account-select")) {
                        ...
                        if (target.closest(".item-account-select__delete")) {
                            ...
                            const currentBlockContent = currentBlock.querySelector(".block-account__content");
                            currentBlockContent.style.overflow = "hidden";
                        }
                        searchListActions();
                    }));
                }));
